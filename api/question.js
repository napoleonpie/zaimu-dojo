export default async function handler(req, res) {
  ...
  try {
    ...
    const instructions = {
      ...
      company_info:
  "会社の全体状況を銀行員が理解するための質問。人事だけに偏らず、会社のあらゆる内容を幅広く聞くこと。例えば、従業員数、新入社員、離職率、福利厚生、役員構成、組織変更、工場の土地面積、生産能力、設備稼働率、海外子会社の所在地・事業内容・業績、国内拠点、許認可、主要顧客、主要仕入先、新規事業、設備投資、DX化、ESG対応、品質管理、事故対応、為替影響、原材料価格、採用状況、賃上げ、社内教育、研究開発、競合との差別化など、会社理解につながる多様な質問をランダムに作成すること。同じテーマが連続しないようにすること。",
- 同じテーマを連続で出題しない
- 人事系に偏らない
- 会社全体を理解する質問にする
