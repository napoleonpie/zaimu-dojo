export default async function handler(req, res) {
  ...
  try {
    ...
    const instructions = {
      basic: "基礎問題。事業内容、BS、PL、業績、借入状況、資金繰りなどをシンプルに確認する質問。",
      advanced: "応用問題。業績、BS、借入、金利、投資計画、経済環境など複数情報を組み合わせた銀行面談質問。",
      performance_debt: "業績・借入状況に関する問題。売上、利益、借入残高、DSCR、返済能力、金利条件を中心に質問。",
      rates_macro: "金利・経済に関する問題。日銀政策、TIBOR、TONA、短プラ、インフレ、原油、為替を絡めた質問。",
      random: "基礎・応用・業績借入・金利経済の中からランダムで問題を作成。"
    };
...
`;
    ...
    result.category = result.category || "財務・銀行面談";
